    ...
    for ($day = 1; $day <= $daysCount; $day++, $str++) {
        ...
        <div class='row'>
            <div class='col-lg-12'>
                ...
                text-align:center;height:85px;color:#FFFFFF;margin-bottom:-10px;vertical-align:bottom;width:102%;left:-2px;right:0px'>
...
?>
    ...
    <body style="background-color:rgba(0,5,5,0.8);margin-top:0px">
        ...
        <div class="wrapper ml-auto"  style="padding-left:30px">
        ...
        <div class="modal fade modal-primary" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-login" style="margin:auto;margin-top:4%">
                <div class="modal-content" style="background-color:#333333">
                    <div class="card card-login card-plain" style="background-color:#333333;width:600px">
                                ...
                                <div class="card-body" style="text-align:center">
                                    ...
                                    <div class="form-row">
                                        <div class="form-check form-check-inline" style="position: relative;left:45px;width:480px">
                                            <div class="input-group no-border input-xs " data-toggle="tooltip" data-placement="right" title="Horaire de début">
                                                ...
                                                name="appName" id="1" min="0" max="23"
                                                value="<?php if(isset($flagName)){ echo $flagName; } ?>" style="height:45px;border-top-right-radius:0px;border-bottom-right-radius:0px" 
                                                ...
                                                name="appName" id="1" min="0" max="55" step="5"
                                                value="<?php if(isset($flagName)){ echo $flagName; } ?>" style="height:45px;border-top-right-radius:0px;border-bottom-right-radius:0px" 
                                    ...
                                    <div class="content-center-brand" style="margin:auto">
                                        ...
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="addStatus" id="inlineRadio1" value="1" onchange="showIt(this.value);document.getElementById('endDate').value = document.getElementById('1').value"> Évènement récurrent
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="addStatus" checked id="inlineRadio2" value="0" onchange="showIt(this.value);document.getElementById('endDate').value = document.getElementById('1').value"> Évènement ponctuel
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-row" id="loulilol" style="display:none;margin-top:10px">
                                        ...
                                        title="Date de fin de réccurence">
                                            ...
                                            <input type="date" class="form-check form-check-inline form-control" name="appPlace" min="<?= $todays; ?>" id="endDate"
                                            value="<?php if(isset($flagName)){ echo $flagName; } ?>" style="height:45px;border-top-right-radius:0px;border-bottom-right-radius:0px" 
                                            autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="addFreq" id="inlineRadio1" value="1">Chaques jours
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="addFreq" id="inlineRadio2" value="7">Chaques semaine
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="addFreq" id="inlineRadio2" value="month">Chaques mois
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                        </div>
                                    ...
                                    <div class="form-row" style="margin-top:5px">
                                        ...
                                        title="Nous servira à localiser l'évènement. Veuillez indiquer au minimum la rue et le code postal (ou la ville)">
                                            ...
                                            name="appPlace" min="<?= $todays; ?>" onkeyup="myMapz(this.value)"
                                            value="<?php if(isset($flagName)){ echo $flagName; } ?>" style="height:45px;border-top-right-radius:0px;border-bottom-right-radius:0px" 
                                            autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-row" style="margin-top:12px">
                                        <div class="form-check" style="margin:auto;width:470px;left:5px" data-toggle="tooltip" data-placement="right" title="Notes (non obligatoires)">
                                            ...
                                            <textarea type="password" placeholder="Pense-bête" name="appNotes" id="1" class="form-control mod-input" 
                                            rows="10" lines="50" 
