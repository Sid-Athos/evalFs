                    ...
                    <div class="card" style="border:none;position:relative;top:-200px;min-width: 310px;">
                        ...
                        <div class="back" style="overflow-y:scroll;overflow-x:hidden;background-color:#212529;border-top-left-radius:5px;border-top-right-radius:5px">
                            <div class="content" id="rdv<?php echo $res[$i]['appId'];?>" style="border-top-left-radius:5px;border-top-right-radius:5px;font-size:16px">
                                ...
                                <div class="form-check" style="background-color:transparent;color:#FFFFFF;max-height:10px;min-height:10px;height:10px;margin-left:25px;position:relative;margin-bottom:30px;margin-left:60px" >
                        ...
                        ?>
                            ...
                            <div class="content" id="rdv<?php echo $res[$i]['appId'];?>" style="border-top-left-radius:5px;border-top-right-radius:5px;font-size:16px">
                                ...
                                <i class="now-ui-icons ui-1_simple-remove" onclick="killApp(<?php echo $res[$i]['appId'];?>);" style="cursor:pointer;font-size:18px"></i>
                                    ...
                                    <div class="form-check" style="background-color:transparent;color:#FFFFFF;max-height:10px;min-height:10px;height:10px;margin-left:25px;margin-top:15px;position:relative;margin-bottom:39px" >
                                        <form method="post" action="index.php?page=apps" style="margin-top:15px">
                                            <button type="submit" name="editApp" value="<?php echo $res[$i]['appId']; ?>" class="btn sid form-check-inline"
                                            style="left:50px;margin-top:-5px">
                                            Modifier l'évènement
